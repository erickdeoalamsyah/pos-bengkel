...
//             className="px-3 py-2 rounded-xl border border-white/10 bg-black"
//           /> */}
...
//             className="px-3 py-2 rounded-xl border border-white/10 bg-black placeholder:text-slate-500 col-span-2 sm:col-span-2"
//           />
//           <label className="group inline-flex select-none items-center gap-3 text-sm">
//             {/* checkbox native, disembunyikan secara visual */}
//             <input
//               type="checkbox"
...
//       peer-checked:bg-emerald-500/20 peer-checked:border-emerald-400
